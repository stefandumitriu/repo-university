function [H S V] = rgb_hsv(R, G, B)
  ...
  # daca un element este 0 inseamna ca Cmax coincide cu R1/G1/B1 in acel pixel
  # verificam daca indexul corespondent din matricea delta nu e cumva 0, daca e va da eroare
